...
A token is used for authetication to see if a user can access the web page.

- [ ] What steps can you take in your web apps to keep your data secure?

You set up authetication by getting the token from the backend and if a users token matches the token of the autheticated user, they can log in.
